package com.example.flutterpluginupdate.kaba;

import android.app.Application;
import android.content.SharedPreferences;
import android.util.Log;

import com.example.flutterpluginupdate.OpenKeyManager;
...
import com.example.flutterpluginupdate.kaba.util.BLEDataHandler;
import com.example.flutterpluginupdate.kaba.util.Settings;
import com.example.flutterpluginupdate.kaba.util.Utils;
...
import static com.example.flutterpluginupdate.kaba.util.Settings.mobileAppId;
...
public class Kaba implements LegicMobileSdkSynchronizeEventListener,
        ...
        public void onResponse(Call<KabaToken> call, Response<KabaToken> response) {
            if (response.isSuccessful()) {
                ...
                if (kabaToken != null && kabaToken.getData() != null && kabaToken.getData().getCode() != null &&
                    ...
                    mOpenKeyCallBack.initializationFailure(com.example.flutterpluginupdate.Utilities.Response.INITIALIZATION_FAILED);
        ...
        try {
            if (!mManager.isRegisteredToBackend()) {
                ...
                if (haveKey() && mobileKeyStatusId == 3) {
                    ...
                    mOpenKeyCallBack.isKeyAvailable(true, com.example.flutterpluginupdate.Utilities.Response.FETCH_KEY_SUCCESS);
                } else {
    ...
    private void synchProcess() {
        ...
        if (failedCounter > 4) {
            ...
            mOpenKeyCallBack.isKeyAvailable(false, com.example.flutterpluginupdate.Utilities.Response.FETCH_KEY_FAILED);
        } else {
    ...
    public void readerLcMessageEvent(byte[] data, LcMessageMode lcMessageMode,
        ...
        if (dataHandler.isAccessGranted()) {
            mOpenKeyCallBack.stopScan(true, com.example.flutterpluginupdate.Utilities.Response.LOCK_OPENED_SUCCESSFULLY);
            if (isLoginActionFired) {
                isLoginActionFired = false;
                Api.logSDK(mContext, 1);
            }
        } else {
            mOpenKeyCallBack.stopScan(false, com.example.flutterpluginupdate.Utilities.Response.LOCK_OPENING_FAILURE);
