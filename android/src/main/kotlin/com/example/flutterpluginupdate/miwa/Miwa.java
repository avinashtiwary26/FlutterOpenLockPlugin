package com.example.flutterpluginupdate.miwa;
    ...
    private void setUpMiwa() {
        try {
            ...
            if (haveKey() && mobileKeyStatusId == 3) {
                ...
                openKeyCallBack.isKeyAvailable(true, com.example.flutterpluginupdate.Utilities.Response.FETCH_KEY_SUCCESS);
                return;
            }
    ...
    private void handleResult(Intent intent) {
        ...
        switch (type) {
            ...
            case Alv2NotifyType.AUTH_RES: {
                if (code == Alv2ResultCode.SUCCESS) {
                    openKeyCallBack.stopScan(true, com.example.flutterpluginupdate.Utilities.Response.LOCK_OPENED_SUCCESSFULLY);
                    ...
                    openKeyCallBack.stopScan(false, com.example.flutterpluginupdate.Utilities.Response.LOCK_OPENING_FAILURE);
